  ...
  publishDiary: function () {
    ...
    addPunchCardDiary = new Promise(function (resolve) {
      wx.request({
        ...
        url:'http://localhost:31005/ClockDiary/ClockCreate',
        method: 'post',
        data: {
        ...
        success: function (res) {
          console.log("ClockCreate",res);
          if (res.statusCode === 200) {
            that.data.diaryId = parseInt(res.data.data);
            resolve(true);
          } else {
            wx.showToast({
  ...
  uploadDiaryResource: function (currResFileInfo) {
    ...
    uploadTask = new Promise(function (resolve) {
      wx.uploadFile({
        ...
        url:"http://localhost:31005/WxFile/fileUploadQnu",
