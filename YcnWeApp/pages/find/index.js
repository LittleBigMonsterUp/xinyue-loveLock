...
Page({
    ...
    getPunchCardProjectRecommendList: function (pageNo) {
        ...
        wx.request({
            ...
            url:"http://localhost:31005/ClockDetail/getProjectInfoList",
            method: 'post',
            data: {
                nextPage: pageNo,
            ...
            success: function (res) {
                ...
                switch (res.statusCode) {
                    case 200:
                        ...
                        console.log("onePagePunchCardProjectRecommendList",that.data.onePagePunchCardProjectRecommendList);
                        break;
                    default :
                        // 获取数据失败则一直显示空白页
